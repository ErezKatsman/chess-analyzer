...
function resultBadgeClass(isWon: boolean, isDraw: boolean): string {
...
function colorBadgeClass(isWhite: boolean): string {
  return isWhite
...
function safeOpening(opening: IGame['gameDetails']['opening']): string {
